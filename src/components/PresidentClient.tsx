...
export default function PresidentClient() {
    return (
        <main className="pb-[90px] bg-[#1a1c1a] font-sans">

            <header className="flex items-center justify-center p-6 mb-5">
                <div className="relative group w-full max-w-[400px]">
                    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-gray-800 to-black shadow-[0_50px_100px_-20px_rgba(0,0,0,1)]">
                        <div className="relative h-[550px] w-full transform transition-transform duration-700 group-hover:scale-105">
                            <img
                                src="/photo3.jpg"
                                alt="Бахриддин Сироджов – Президент UNIFIGHT"
                                title="Бахриддин Сироджов"
                        ...
                        <div className="absolute bottom-0 w-full p-8 backdrop-blur-md bg-black/40 border-t border-white/5">
                            ...
                            <h1 className="relative font-serif text-4xl font-black uppercase italic leading-none tracking-tighter text-white">
            ...
            <section className="flex flex-col items-center justify-center p-6 mb-5">
                <div className="w-full max-w-[550px]">
                    ...
                    <article className="relative overflow-hidden rounded-xl border border-white/5 bg-white/[0.02] p-10 backdrop-blur-3xl shadow-[0_40px_80px_-15px_rgba(0,0,0,1)]">
